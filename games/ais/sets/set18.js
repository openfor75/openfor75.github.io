...
/* ============================================================
   ...
   ★ 本卷是特殊題型,出題模式與其他題組不同 ────────────────
     ...
     所以本題組改用「餘額比較」的方式出題:
       ...
       (本檔是「免改引擎」的備援版:表格與提示條都已改寫成純文字,
        直接併進題目裡,不需要動 index.html 一個字。)
     ...
     ★★ 本檔不需要任何引擎修改,放進 sets/ 加一行 script 就會動。
   ────────────────────────────────────────────────
...
window.AIS_SETS.push({
  ...
  txns: [
    ...
    { no: 1, date: '12/08',
      text: '銷貨收入增加係因8日之賒銷。　【餘額比較】銷貨收入:11/30 試算表 貸 78,000　→　12/31 調整後試算表 貸 98,000',
    ...
    { no: 2, date: '12/10',
      text: '於10日賒購商品。　【餘額比較】應付帳款:11/30 試算表 貸 52,000　→　12/31 調整後試算表 貸 62,000',
    ...
    { no: 5, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(1):預期信用減損損失。　【12/31 調整後試算表】備抵損失-應收帳款 貸 6,000、預期信用減損損失 借 2,000',
      entries: [{ dr: [{ acct: '預期信用減損損失', amt: 2000 }],
                  cr: [{ acct: '備抵損失-應收帳款', amt: 2000 }] }],
      note: '帳上備抵損失已有貸餘 4,000,應有餘額 6,000,故補提 2,000。' },

    { no: 6, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(2):預付保險費。　【12/31 調整後試算表】預付保險費 借 2,000',
    ...
    { no: 7, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(3):用品盤存。　【12/31 調整後試算表】用品盤存 借 1,500',
    ...
    { no: 8, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(4):累計折舊-房屋及建築。　【12/31 調整後試算表】累計折舊-房屋及建築 貸 140,000',
      entries: [{ dr: [{ acct: '折舊', amt: 70000 }],
                  cr: [{ acct: '累計折舊-房屋及建築', amt: 70000 }] }],
      note: '帳上累計折舊 70,000,應有 140,000,故本年度提列折舊 70,000。' },

    { no: 9, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(5):預收佣金。　【12/31 調整後試算表】預收佣金 貸 38,000',
    ...
    { no: 10, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(6):應付薪資。　【12/31 調整後試算表】應付薪資 貸 85,000',
      entries: [{ dr: [{ acct: '薪資支出', amt: 85000 }],
                  cr: [{ acct: '應付薪資', amt: 85000 }] }],
      note: '帳上應付薪資為 0,應有 85,000。薪資已發生但尚未支付,故借記薪資支出 85,000、貸記應付薪資 85,000。' },

    { no: 11, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(7):應收利息。　【12/31 調整後試算表】應收利息 借 3,600',
      entries: [{ dr: [{ acct: '應收利息', amt: 3600 }],
                  cr: [{ acct: '利息收入', amt: 3600 }] }],
      note: '帳上應收利息為 0,應有 3,600。利息已賺得但尚未收現,故借記應收利息 3,600、貸記利息收入 3,600。' },

    { no: 12, date: '12/31',
      text: '※ 請先按下方「查帳」看這個項目目前帳上的餘額,再跟 12/31 調整後試算表比較,兩者的差額就是本題要調整的金額。　調整項目(8):銷貨成本。　【12/31 調整後試算表】存貨 借 15,000、銷貨成本 借 67,000',

...
window.AIS_SETS.push({
  ...
  txns: [
    /* ── 一、12月份交易事項 ── */
    { no: 1, date: '12/08',
      text: '銷貨收入增加係因8日之賒銷。※按下方「查帳」可看11/30帳上餘額。　',
    ...
    { no: 2, date: '12/10',
      text: '於10日賒購商品。※按下方「查帳」可看11/30帳上餘額。',
    ...
    { no: 7, date: '12/31',
      text: '調整項目(3):用品盤存。※按下方「查帳」看11/30帳上餘額。',
